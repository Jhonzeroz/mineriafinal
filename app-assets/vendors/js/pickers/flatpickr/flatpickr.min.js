! function(e, t) {
	...
	function y(f, g) {
		...
		function T(e) {
			0 === h.selectedDates.length && ie(), void 0 !== e && "blur" !== e.type && function(e) {
				...
				var a = parseFloat(n.getAttribute("min")),
					...
					d = c + l * (e.delta || (t ? 38 === e.which ? 1 : -1 : 0));
				if (void 0 !== n.value && 2 === n.value.length) {
					var s = n === h.hourElement,
						u = n === h.minuteElement;
					d < a ? (d = r + d + o(!s) + (o(s) && o(!h.amPM)), u && j(void 0, -1, h.hourElement)) : d > r && (d = n === h.hourElement ? d - r - o(!h.amPM) : a, u && j(void 0, 1, h.hourElement)), h.amPM && s && (1 === l ? d + c === 23 : Math.abs(d - c) > l) && (h.amPM.textContent = h.l10n.amPM[o(h.amPM.textContent === h.l10n.amPM[0])]), n.value = i(d)
				}
			}(e);
		...
		h.parseDate = D({
			...
			if (void 0 === t && (t = h._positionElement), !0 === h.isMobile) return e && (e.preventDefault(), e.target && e.target.blur()), void 0 !== h.mobileInput && (h.mobileInput.focus(), h.mobileInput.click()), void ge("onOpen");
			if (!h._input.disabled && !h.config.inline) {
				var n = h.isOpen;
				h.isOpen = !0, n || (h.calendarContainer.classList.add("open"), h._input.classList.add("active"), ge("onOpen"), le(t)), !0 === h.config.enableTime && !0 === h.config.noCalendar && (0 === h.selectedDates.length && ie(), !1 !== h.config.allowInput || void 0 !== e && h.timeContainer.contains(e.relatedTarget) || setTimeout(function() {
			...
			if (void 0 === t && (t = !1), void 0 === n && (n = h.config.dateFormat), 0 !== e && !e || e instanceof Array && 0 === e.length) return h.clear(t);
			fe(e, n), h.showTimeInput = h.selectedDates.length > 0, h.latestSelectedDateObj = h.selectedDates[h.selectedDates.length - 1], h.redraw(), A(), I(), 0 === h.selectedDates.length && h.clear(!1), we(t), t && ge("onChange")
		}, h.toggle = function(e) {
		...
		return function() {
			h.element = h.input = f, h.isOpen = !1,
				function() {
					...
					for (u = 0; u < h.config.plugins.length; u++) {
